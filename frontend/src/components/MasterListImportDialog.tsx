...
export default function MasterListImportDialog({ open, onClose, onUploaded }: Props) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/admin/master-list/batch", {
        method: "POST",
    ...
    <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
      ...
      <DialogContent>
        <Typography variant="body2" color="text.secondary" mb={2}>
          Upload a .csv or .xlsx file with columns: 9-Digit ID No., Last Name, First Name, Middle Name
          (optional), Mobile Number, Email Address. All imported rows are created as ACTIVE.
        </Typography>
